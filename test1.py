...
# Stiffness
stiffness = SPD(dim)
stiffness.vec_ = nn.Parameter(torch.tensor([1.0, 0.0]))
lambda_1 = 1.0
stiffness.eig_ = nn.Parameter(lambda_1 * torch.ones(2))
...
samples = np.zeros((steps, num_samples, dim))
